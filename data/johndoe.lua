...
--Chat Stuff--
local function chatall(x)
for _,v in ipairs(Players:GetPlayers()) do
if v.Character and v.Character:FindFirstChild("Head") then
game:GetService("Chat"):Chat(v.Character.Head,x,'Blue')
end
end
end

chatall("Im back... Your overlord is back...")
wait(5)
chatall("Good luck, Youll need it.")
wait(5)
chatall("Theyre all yours, Mr. Doe.")
wait(5)

--Character Stuff--
for i, ch in ipairs(chara:GetChildren()) do
if ch.Name == "Torso" then
ch.roblox.Transparency = 1
elseif ch.Name == "Head" then
ch.face.Transparency = 1
ch.Transparency = 1
elseif ch.ClassName == "Accessory" or ch.ClassName == "Hat" or ch.ClassName == "Shirt" or ch.ClassName == "Pants" or ch.ClassName == "ShirtGraphic" then
ch:Destroy()
end
end
...
--Outfit--
local Replacements = {PlaybackSpeed="Pitch"} -- backportin' baby!
local New = function(Object, Parent, Name, Data)
	...
	for Index, Value in pairs(Data or {}) do
		xpcall(function()
			...
			print("err on",Index,"btw, replacement:",Replacements[Index])
			if Replacements[Index] then Object[Replacements[Index]] = Value end
		end)
	end
...
local Chest = New("Model",chara,"Chest",{})
...
CorruptedPart = New("Part",Chest,"CorruptedPart",{FormFactor="Custom",BrickColor = BrickColor.new("Really black"),Material = Enum.Material.Granite,Size = Vector3.new(0.400000006, 0.400000066, 1),CFrame = CFrame.new(2.29174757, 6.71645212, 1.54485857, -0.00110228383, -0.00980954897, -0.9999578, -1.00000536, 0.000536905834, 0.00109708123, 0.000526248943, 0.99994868, -0.00981033035),CanCollide = false,BackSurface = Enum.SurfaceType.SmoothNoOutlines,BottomSurface = Enum.SurfaceType.SmoothNoOutlines,FrontSurface = Enum.SurfaceType.SmoothNoOutlines,LeftSurface = Enum.SurfaceType.SmoothNoOutlines,RightSurface = Enum.SurfaceType.SmoothNoOutlines,TopSurface = Enum.SurfaceType.SmoothNoOutlines,Color = Color3.new(0.0666667, 0.0666667, 0.0666667),})
Mesh = New("BlockMesh",CorruptedPart,"Mesh",{Scale = Vector3.new(1.10000002, 1.10000002, 1.10000002),})
...
local LeftArm = New("Model",chara,"LeftArm",{})
...
local EffCorruptedPart = New("Part",LeftArm,"EffCorruptedPart",{FormFactor="Symmetric",BrickColor = BrickColor.new("Really black"),Material = Enum.Material.Granite,Size = Vector3.new(1, 1, 1),CFrame = CFrame.new(1.92512023, 5.81624889, 3.24619365, -0.048417028, -0.0324150361, 0.998301387, -0.00116700074, 0.999474525, 0.03239654, -0.998826742, 0.000403525919, -0.0484294258),CanCollide = false,BackSurface = Enum.SurfaceType.SmoothNoOutlines,BottomSurface = Enum.SurfaceType.SmoothNoOutlines,FrontSurface = Enum.SurfaceType.SmoothNoOutlines,LeftSurface = Enum.SurfaceType.SmoothNoOutlines,RightSurface = Enum.SurfaceType.SmoothNoOutlines,TopSurface = Enum.SurfaceType.SmoothNoOutlines,Color = Color3.new(0.0666667, 0.0666667, 0.0666667),})
...
local LeftLeg = New("Model",chara,"LeftLeg",{})
...
local RightArm = New("Model",chara,"RightArm",{})
...
CorruptedPart = New("Part",RightArm,"CorruptedPart",{FormFactor="Symmetric",BrickColor = BrickColor.new("Really black"),Material = Enum.Material.Granite,Size = Vector3.new(1, 2, 1),CFrame = CFrame.new(2.011096, 6.3169179, -3.92581391, -0.964945257, -0.262290984, 0.00919180829, -0.251027077, 0.93259424, 0.259333313, -0.0765930116, 0.247935042, -0.965744138),CanCollide = false,BackSurface = Enum.SurfaceType.SmoothNoOutlines,BottomSurface = Enum.SurfaceType.SmoothNoOutlines,FrontSurface = Enum.SurfaceType.SmoothNoOutlines,LeftSurface = Enum.SurfaceType.SmoothNoOutlines,RightSurface = Enum.SurfaceType.SmoothNoOutlines,TopSurface = Enum.SurfaceType.SmoothNoOutlines,Color = Color3.new(0.0666667, 0.0666667, 0.0666667),})
Mesh = New("BlockMesh",CorruptedPart,"Mesh",{Scale = Vector3.new(1.10000002, 1.10000002, 1.10000002),})
...
local RightLeg = New("Model",chara,"RightLeg",{})
...
--Sounds--
local slashsnd = New("Sound",chara.Torso,"Slash",{SoundId = "rbxassetid://28144425",PlaybackSpeed = .7,Volume = 5})
local hitsnd = New("Sound",chara.Torso,"Hit",{SoundId = "rbxassetid://429400881",PlaybackSpeed = .7,Volume = 5})
local telesnd = New("Sound",chara.Torso,"Tele",{SoundId = "rbxassetid://2767090",PlaybackSpeed = .7,Volume = 5})
local burnsnd = New("Sound",chara.Torso,"Burn",{SoundId = "rbxassetid://32791565",PlaybackSpeed = .7,Volume = 5})
local music1 = New("Sound",chara.Torso,"Music1",{SoundId = "rbxassetid://151038517",PlaybackSpeed = .5,Volume = 10,Looped = true})
local music2 = New("Sound",chara.Torso,"Music2",{SoundId = "rbxassetid://11984351",PlaybackSpeed = .2,Volume = 5,Looped = true})
local deathmus = New("Sound",chara.Torso,"DeathMus",{SoundId = "rbxassetid://19094700",PlaybackSpeed = .5,Volume = 5,Looped = true})
local deathex = New("Sound",chara.Torso,"DeathEx",{SoundId = "rbxassetid://11984351",PlaybackSpeed = 1,Volume = 5})
music1:Play()
music2:Play()

--Animations--
local swinganim = chara.Humanoid:LoadAnimation(New("Animation",chara,"Swing",{AnimationId = "rbxassetid://186934658"}))
...
tecks.Text = "John Doe"
local hasFantasy;
hasFantasy = pcall(game.GetService, game, "AddThirdPartyUserService") -- awesome backport HACK for elevatated scripts!
hasFantasy = hasFantasy or pcall(function() return workspace.Gravity end) -- lazy backport hack for unelevated scripts
tecks.Font = hasFantasy and "Fantasy" or "Arial"
...
--Skybox--
local skybox = Instance.new("Part",chara)
skybox.FormFactor = "Custom"
...
chara:SetPrimaryPartCFrame(CFrame.new(pos.X,pos.Y+1.5,pos.Z))--works on 2016 :p
end

--Grab--
local function Grab(mouse)
...
local pat = Instance.new("Part",workspace)
pat.Transparency = 1
pat.Anchored = true
...
music1:Stop()
music2:Stop()
deathmus.Parent = workspace
deathex.Parent = workspace
deathmus:Play()
deathex:Play()
...
pcall(function() ex.Visible = false end)
...
local jtrace = Instance.new("Part",workspace)
jtrace.Name = "JDTrace"
jtrace.FormFactor="Custom"
