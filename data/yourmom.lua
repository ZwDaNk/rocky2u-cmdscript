...
GetObjx = function(asset) local id = tonumber(asset:match("%d+")) return game:GetService('InsertService'):LoadAsset(id):GetChildren() end
-- END
if game.CoreGui:FindFirstChild('YourMom') ~= nil then
	game.CoreGui.YourMom:Destroy()
end	
wait(0.1)
GetObjx('http://www.roblox.com/asset/?id=288994927')[1].Parent = game.CoreGui
...
-- DATA --
local DATA = GetObjx('http://www.roblox.com/asset/?id=291560220')[1]
...
ServerPage2.Map.MouseButton1Down:connect(function ()
	...
	for i,v in pairs(game.Players:GetChildren()) do
	    ...
	    local Load = GetObjx('http://www.roblox.com/asset/?id=296400126')[1]
...
LocalPlayerPage1.Purge.MouseButton1Down:connect(function ()
	...
	GetObjx('http://www.roblox.com/asset/?id=32278814')[1].Parent = Player.Character
	
	GetObjx('http://www.roblox.com/asset/?id=20418416')[1].Parent = Player.Character
...
LocalPlayerPage2.Fly.MouseButton1Down:connect(function ()
	...
	loadstring(GetObjx('rbxassetid://293298728')[1].Source)()
	
end)
LocalPlayerPage2.Cape.MouseButton1Down:connect(function ()
	
	loadstring(GetObjx('rbxassetid://293812864')[1].Source)()
	
end)
--Toys Page 1--
ToysPage1.Telekinesis.MouseButton1Down:connect(function ()
	
	loadstring(GetObjx('rbxassetid://288628070')[1].Source)()
...
ToysPage1.PartMaker.MouseButton1Down:connect(function ()
	...
	GetObjx('rbxassetid://288113452')[1].Parent = game.Players.LocalPlayer.PlayerGui
...
ToysPage1.Jeep.MouseButton1Down:connect(function ()
	...
	local Jeep = GetObjx('rbxassetid://264273799')[1]
...
ToysPage1.Bait.MouseButton1Down:connect(function ()
	...
	loadstring(GetObjx('rbxassetid://293026637')[1].Source)()
	
end)
ToysPage1.HR.MouseButton1Down:connect(function ()
	
	loadstring(GetObjx('rbxassetid://293039308')[1].Source)()
...
InHatsPage.STF.MouseButton1Down:connect(function ()
	...
	GetObjx('http://www.roblox.com/asset/?id=1285307')[1].Parent = Player.Character
	
end)
InHatsPage.RSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=72082328')[1].Parent = Player.Character
	
end)
InHatsPage.OSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=215751161')[1].Parent = Player.Character
	
end)
InHatsPage.PSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=63043890')[1].Parent = Player.Character
	
end)
InHatsPage.GSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=100929604')[1].Parent = Player.Character
	
end)
InHatsPage.TSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=147180077')[1].Parent = Player.Character
	
end)
InHatsPage.BSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=259423244')[1].Parent = Player.Character
	
end)
InHatsPage.BSSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=98346834')[1].Parent = Player.Character
	
end)
InHatsPage.MBSTF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=119916949')[1].Parent = Player.Character
	
end)
InHatsPage.CWS.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=11748356')[1].Parent = Player.Character
	
end)
InHatsPage.CWHP.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=1235488')[1].Parent = Player.Character
	
end)
InHatsPage.BBR.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=52458643')[1].Parent = Player.Character
	
end)
InHatsPage.DE.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=21070012')[1].Parent = Player.Character
	
end)
InHatsPage.DF.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=48545806')[1].Parent = Player.Character
	
end)
InHatsPage.DI.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=31101391')[1].Parent = Player.Character
	
end)
InHatsPage.DAS.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=162067148')[1].Parent = Player.Character
	
end)
InHatsPage.DM.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=64444871')[1].Parent = Player.Character
	
end)
InHatsPage.DAU.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=138932314')[1].Parent = Player.Character
	
end)
InHatsPage.DR.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=250395631')[1].Parent = Player.Character
	
end)
InHatsPage.DV.MouseButton1Down:connect(function ()
	
	GetObjx('http://www.roblox.com/asset/?id=96103379')[1].Parent = Player.Character
